  ...
  const fetchTechnology = async () => {
    try {
      ...
      if (response.data.success) {
        setTechnologyDetails(response.data.data);
        setLoading(false);
      } else {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/api/technology-Portfolio/create-technology-portfolio`,
        formData,
        {withCredentials: true}
      );
  ...
  const handlesubmitedit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_URL}/api/technology-Portfolio/edit-technology-portfolio/${editid}`,
    ...
    if (result.isConfirmed) {
      try {
        const res = await axios.delete(
          `${API_URL}/api/technology-Portfolio/delete-technology-portfolio/${id}`,
          {withCredentials: true}
        );
        Swal.fire("Deleted!", "The Status has been deleted.", "success");
        // console.log("res", res);
        setTechnologyDetails((prev) => prev.filter((item) => item._id !== id));
        // fetchProject();
      } catch (err) {
...
export default Technology_Details;
