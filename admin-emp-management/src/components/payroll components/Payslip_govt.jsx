...
const Payslip_govt = () => {
 ...
 <div className="p-3 border border-black text-sm font-serif">
  ...
  படிவம் - டி ஊதியச் சீட்டு / விடுப்பு அட்டை FORM - T WAGE SLIP / LEAVE CARD
      ...
      <div className=" mb-3">
        <div className="flex w-full">
          ...
          <span className="border-b border-black inline-block w-[54%] ml-2"></span>
        </div>
        {/* <div>
          <span className="font-semibold">Date :</span>
      ...
      <div className="space-y-2 mb-4">
        <div className="flex w-full">
          ...
          <span className="border-b border-black inline-block w-[64%] ml-2"></span>
        </div>

        <div className="flex w-full">
          <div className="flex w-[60%]">
            <span className="font-semibold ">3. Father’s/Husband’s Name :</span>
            <span className="border-b border-black inline-block w-[45%] ml-2"></span>
          </div>
          <div className="flex  w-[40%]">
            <span className="font-semibold">4. Designation :</span>
            <span className="border-b border-black inline-block w-[56%] ml-2"></span>
          </div>
        </div>
        ...
        <div className="flex w-full">
          <div className="flex w-[50%]">
            ...
            <span className="border-b border-black inline-block w-[37%] ml-2"></span>
          </div>
          <div className="flex  w-[50%]">
            <span className="font-semibold">6. Wage Period :</span>
            <span className="ml-2">From</span>
            <span className="border-b border-black inline-block w-[23%] mx-1"></span>
            <span>To</span>
            <span className="border-b border-black inline-block w-[23%] ml-1"></span>
          </div>
        </div>
      </div>
    ...
    <div className="flex">
      ...
      <div className="border border-black">
        <div className="flex border-b border-black text-center font-bold">
          <div className="w-20 border-r border-black">Rs.</div>
  ...
  <div>
    ...
    <div className="flex">
      {/* LABELS – OUTSIDE */}
      <div className="flex-1 space-y-[6px] pr-2">
        <p>(i) E.P.F.</p>
        <p>(ii) E.S.I.</p>
        <p>(iii) Other Deductions</p>
        <p className="font-semibold">TOTAL Deductions</p>
        <p className="font-semibold mt-4">Net Amount Paid</p>
      </div>
      ...
      <div className="space-y-2 mb-6 mt-6">
        ...
        <div>
          <span className="font-semibold">9. Leave at Credit :</span>
          <span className="ml-2">CL :</span>
          <span className="border-b border-black w-10 inline-block mx-1"></span>
          <span>SL :</span>
          <span className="border-b border-black w-10 inline-block mx-1"></span>
      ...
      <div className="grid grid-cols-2 gap-10 mt-8 text-xs">
        ...
        <div>
          <p className="border-t border-black pt-1 text-right">
