...
const Mom_mainbar = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      else toast.error("Failed to create MOM");
    } finally {
      setLoading(false);
    }
  };
  ...
  const openEditModalWith = async (mom) => {
    ...
    setFormProject(mom?.projectName?._id);
    if (mom?.attendees) {
  ...
  const handleUpdate = async (e) => {
    ...
    if (
      !formAttendees ||
      (Array.isArray(formAttendees) && formAttendees.length === 0)
    )
      newErrors.attendees = "At least one attendee is required.";
    if (!formDescription) newErrors.description = "Description is required.";
    ...
    try {
      ...
      if (err.response?.data?.errors) setErrors(err.response.data.errors);
      else toast.error("Failed to update MOM");
    } finally {
      setLoading(false);
    }
  };
  ...
  const deleteMom = (id) => {
    Swal.fire({
      title: "Are you sure?",
      text: "This will delete the MOM permanently.",
      icon: "warning",
  ...
  const columns = [
    ...
    },
    {
      field: "projectName",
      header: "Project Name",
      body: (row) => row?.projectName?.name || "-",
    },
    {
      field: "client",
      header: "Client",
      body: (row) => row?.clientName?.client_name || "-",
    },
    // {
    //   field: "document",
    ...
    <div className="flex flex-col justify-between overflow-x-hidden bg-gray-100 min-h-screen px-3  md:px-5 py-2 md:py-5 w-screen ">
      ...
      <div>
        ...
        <div className="flex justify-end mt-2 md:mt-0 gap-2 text-sm items-center ">
          ...
          <p>{">"}</p>
          <p className="text-sm text-blue-500">Minutes Of Meeting</p>
        </div>
            ...
            <div className="fixed inset-0 bg-black/10 backdrop-blur-sm bg-opacity-50 z-50">
              ...
              >
                ...
                <div className="p-5 px-10">
                  <p className="text-2xl md:text-3xl font-medium">Add MOM</p>
          ...
          {isEditModalOpen && (
            <div className="fixed inset-0 bg-black/10 backdrop-blur-sm bg-opacity-50 z-50">
              ...
              >
                ...
                <div className="p-5 px-10">
                  <p className="text-2xl md:text-3xl font-medium">MOM - Edit</p>
                  ...
                  <div className="space-y-4 text-gray-700">
                    <div className="grid grid-cols-1 gap-y-5">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{viewData?.clientName?.client_name || "-"}</span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{viewData?.projectName?.name || "-"}</span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {viewData?.attendees?.map((att, index) => (
                            <span
                              key={index}
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="flex flex-wrap gap-3">
                          {viewData?.documents?.map((doc, index) => (
                            ...
                            >
                              <IoDocument /><span className="text-sm">{doc.originalName}</span>
                            </a>
                          ))}
                        </div>
                      </div>
