...
//     try {
//       const response = await axios.get(`${API_URL}/api/job-type/view-source`, {
//         withCredentials: true,
//       });
//       // console.log("response:", response)
...
//                   onChange={(e) => setSecondNameFilter(e.target.value)}
//                 />
//               </div>
//               {/* Dropdowns */}
...
//                   onChange={(e) => setInterViewStatusFilter(e.value)}
//                   options={interviewDropDown}
//                   optionValue="value"
//                   optionLabel="label"
//                   filter
...
//                     className="w-[130px] md:w-[160px] border px-3 py-1 rounded"
//                   />
//                 </div>
...
//                 {!filterStartDate && !showDatePicker && (
