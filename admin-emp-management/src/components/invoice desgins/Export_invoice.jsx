    ...
    <div className="p-6">
      ...
      >
        ...
        <div className=" border-r-2 border-l-2 p-1 border-black">
          <p>
            <span className="w-[30%] inline-block pb-2">
              Tax amount (in words)
            </span>
        ...
        <div className="flex  ">
          <div className="w-[62%] border-b-2  border-l-2 border-t-2  border-black">
            <div className=" p-1 border-black">
              {" "}
              <p className="">
                <strong className="w-fit inline-block">
                  Nature Of Supply :{" "}
                </strong>
                <span className="w-full inline-block">
                  zero-rated Supply as per Section 16 IGST Act 2017
                </span>
              </p>
              <p>
                <strong>GST Charged :</strong>
                <span className=" inline-block">
                  No GST is applicable on this invoice as the services are
