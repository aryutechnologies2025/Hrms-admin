  ...
  return (
    <div className="flex flex-col justify-between overflow-x-hidden bg-gray-100 w-screen min-h-screen px-5 pt-2 md:pt-10">
      ...
      <div>
        ...
        <div className="flex flex-col gap-5 md:flex-row justify-between mt-2 md:mt-4">
          <p className="font-semibold text-xl md:text-2xl">Transaction</p>
          <button
            onClick={openAddTransactionModal}
            className=" px-3 py-1 w-fit font-medium text-sm  text-white bg-blue-500 hover:bg-blue-600 rounded-full"
          >
            {" "}
            + Add Transaction
          </button>
