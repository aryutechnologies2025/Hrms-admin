        ...
        {buttonLoading ? (
          ...
          <div className="p-2 md:p-5 w-full  ">
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-around gap-3 md:gap-8 my-4 md:my-8 text-[#6b7280] ">
              ...
              <div className="flex justify-between bg-[#f3f4f610] border px-8 py-6 rounded-lg shadow-sm w-full">
                <div className="">
                  <h2 className="text-[16px]   font-semibold">Active Tasks</h2>
                  <p className="text-[14px]  mt-2">
                    {data?.statusCounts["todo"] +
                      data?.statusCounts["in-progress"] +
                      data?.statusCounts["in-review"] || 0}
                  </p>
                </div>
              ...
              <div className="flex justify-between bg-[#f3f4f610] border px-8 py-6 rounded-lg shadow-sm w-full">
                <div className="">
                  <h2 className="text-[16px]   font-semibold">Closed Tasks</h2>
                  <p className="text-[14px]  mt-2">
          ...
          `}
                                                      >
                                                        {taskType === "bug" ? "B" : taskType.startsWith("maint") ? "M" : "N"}
                                                      </span>
                                                    )}
