...
const Client_view_SubUser_details = () =>{
...
//         setProjectName(response.data.data?.projectId?.name
//  || "");
setProjectName(response.data.data?.projectId || []);
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 w-full ">
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-2 ">
               ...
               <div className="border w-[50%] border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg p-2 text-sm outline-none transition bg-[#fafafa]"
>
...
export default Client_view_SubUser_details;
