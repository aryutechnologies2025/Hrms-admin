  ...
  const columns = [
    ...
    },
    {
      ...
      render: (data, type, row) => {
        ...
        const textColor = data === "1" ? "text-green-600 border rounded-full border-green-600" : "text-red-600 border rounded-full border-red-600";
...
export default Leave_type_details;
