  ...
  const fetchProject = async () => {
    try {
      const response = await axios.get(
        `${API_URL}/api/income/view-financelender`,
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/api/income/create-financelender`,
  ...
  const handlesubmitedit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_URL}/api/income/edit-financelender/${editid}`,
        formData, {withCredentials: true}
      );
      // console.log("response:", response);
      Swal.fire({
    ...
    if (result.isConfirmed) {
      try {
        const res = await axios.delete(
          `${API_URL}/api/income/delete-financelender/${id}`,
          {withCredentials: true}
    ...
    <div className="flex flex-col justify-between bg-gray-100 w-screen min-h-screen px-3 md:px-5 pt-2 md:pt-10">
      ...
      <div>
        ...
        <div className="flex justify-end mt-2 md:mt-0 gap-1 items-center">
          ...
          <p>{">"}</p>
          <p className="text-sm text-blue-500"> Company Lender</p>
          <p>{">"}</p>
          </div>
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 bg-black/10 backdrop-blur-sm bg-opacity-50 z-50">
            ...
            >
              ...
              <div className="p-5">
                <h2 className="text-xl font-semibold mb-4">Edit Lender</h2>
...
export default Finance_lender_details;
