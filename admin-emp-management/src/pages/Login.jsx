...
const inactiveClass = "hover:underline";
  ...
  <div className="min-h-screen bg-[#F3F4F6] flex flex-col ">
    ...
    <div className="px-3">
      ...
      <div className="flex flex-col items-center mt-20 md:mt-0  2xl:mt-14 md:mb-2 xl:mb-2">
        <img src={aryu_logo} alt="aryu logo" className="w-20 mb-1" />
        <p className="text-lg md:text-2xl font-semibold text-[#0050AA]">
          ARYU PORTAL
        </p>
      </div>
      {/* Login Box */}
    ...
    <div className="w-full flex md:mt-3 justify-center bottom-0 fixed">
      <Footer />
    </div>
