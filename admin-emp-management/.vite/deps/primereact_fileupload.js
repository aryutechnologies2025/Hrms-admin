...
import {
  TimesCircleIcon
} from "./chunk-7GXTHYW5.js";
import {
  PlusIcon
} from "./chunk-UU5LTZQ4.js";
import {
  Button
} from "./chunk-U73C72OQ.js";
import {
  TimesIcon
} from "./chunk-JZOFHKRI.js";
import {
  CSSTransition,
  TransitionGroup_default
} from "./chunk-2IAUHQDR.js";
import "./chunk-VPI4FCPN.js";
import "./chunk-AVUONKA5.js";
import "./chunk-HQ6ZTAWL.js";
import {
  CheckIcon
} from "./chunk-FHZ3M5ZY.js";
import "./chunk-IQIDLP6P.js";
import "./chunk-UJE42DUN.js";
import {
  Ripple
} from "./chunk-332M33T7.js";
import {
  IconBase
} from "./chunk-DYHDLWPX.js";
import "./chunk-SAQNUJYF.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
...
var ProgressBar = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React5.createElement("div", _extends5({
      id: props.id,
      ref: elementRef
    }, rootProps), React5.createElement("div", valueProps, label != null && React5.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React5.createElement("div", _extends5({
      id: props.id,
      ref: elementRef
    }, rootProps), React5.createElement("div", containerProps, React5.createElement("div", valueProps)));
  };
...
var FileUpload = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React6.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React6.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React6.useState([]), _React$useState4 = _slicedToArray2(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React6.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  var _React$useState7 = React6.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React6.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var fileInputRef = React6.useRef(null);
  var messagesRef = React6.useRef(null);
  var contentRef = React6.useRef(null);
  var uploadedFileCount = React6.useRef(0);
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React6.createElement("span", _extends6({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React6.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React6.createElement("input", inputProps);
    ...
    var icon = _icon || React6.createElement(PlusIcon, chooseIconProps);
    ...
    return React6.createElement("span", chooseButtonProps, input, chooseIcon2, label, React6.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React6.createElement("img", _extends6({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React6.createElement("div", fileNameProps, file.name);
    var size = React6.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React6.createElement("div", detailsProps, React6.createElement("div", fileNameProps, " ", file.name), React6.createElement("span", fileSizeProps, formatSize(file.size)), React6.createElement(Badge, {
    ...
    var removeButton = React6.createElement("div", actionsProps, React6.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React6.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React6.createElement(React6.Fragment, null, preview, contentBody, removeButton);
    ...
    return React6.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React6.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React6.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar"),
      __parentMetadata: {
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React6.createElement(UploadIcon, uploadIconProps), _objectSpread3({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React6.createElement(TimesIcon, cancelIconProps), _objectSpread3({}, cancelIconProps), {
        props
      });
      uploadButton = React6.createElement(Button, {
        type: "button",
        label: uploadLabel,
        "aria-hidden": "true",
        icon: uploadIcon2,
      ...
      cancelButton = React6.createElement(Button, {
        type: "button",
        label: cancelLabel,
        "aria-hidden": "true",
        icon: cancelIcon2,
    ...
    var header = React6.createElement("div", buttonbarProps, chooseButton2, uploadButton, cancelButton);
    ...
    return React6.createElement("div", rootProps, header, React6.createElement("div", contentProps, progressBar, React6.createElement(Messages, {
      ref: messagesRef,
      __parentMetadata: {
        parent: metaData
      }
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React6.createElement("span", _extends6({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React6.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React6.createElement("span", labelProps, hasFiles ? props.selectedFileLabel || filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
        iconOnly: chooseOptions.iconOnly
      })
    }, ptm("chooseIcon"));
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React6.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React6.createElement(UploadIcon, chooseIconProps);
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread3({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React6.createElement("input", inputProps);
    var rootProps = mergeProps({
      className: classNames(props.className, cx("root")),
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React6.createElement("div", rootProps, React6.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message"),
      __parentMetadata: {
        parent: metaData
      }
    }), React6.createElement("span", basicButtonProps, chooseIcon2, label, input, React6.createElement(Ripple, null)));
  };
  if (props.mode === "advanced") {
