...
$.extend(RowGroup.prototype, {
  ...
  _adjustColspan: function() {
    let cells = $("tr." + this.c.className, this.s.dt.table().body()).find("th:visible, td:visible");
    if (cells.length === 1) {
...
// node_modules/datatables.net-rowgroup-dt/js/rowGroup.dataTables.mjs
var rowGroup_dataTables_default = dataTables_dataTables_default;
export {
  rowGroup_dataTables_default as default
};
...
datatables.net-rowgroup-dt/js/rowGroup.dataTables.mjs:
   ...
   *)
*/
//# sourceMappingURL=datatables__net-rowgroup-dt.js.map
